...
𝐌𝐮𝐬𝐭 𝐓𝐫𝐲: City of San Francisco (Hard Level) hashtag#SQL Interview Question — Solution
...
Function can vary with db: This calculates the length of the business name after removing special symbols like &, -, and _.

**SOLUTION**

<img width="800" height="283" alt="image" src="https://github.com/user-attachments/assets/7ecfdbc7-1550-4db0-82dc-f4d8c59886e8" />
